...
class TestScene extends Scene {
  ...
  FutureOr<void> preload() {
	...
	Future construct() async {
		...
		await animateNumberChange(0, 2739187219738092, Vector3(-2.0, 2.0, 0), m, digits: 4);
			...
			for (var j = 0; j < tmp.length; j++) {
				...
				if (eFlag && isNumber) {
					...
					letter
						...
						..moveToPoint(Vector3(pos[0] + letterSpacing * j - exponentOffset * sinceE, pos[1] + eFlagNumberShift, pos[2]));

				} else {
					letter
						..moveToPoint(Vector3(pos[0] + letterSpacing * j, pos[1] - shift, pos[2]));
				}
